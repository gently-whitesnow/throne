...
Throne — второй мозг техножреца. Хранит его намерения и предпочтения, выдаёт их любому агенту по запросу и учится на каждом диалоге, чтобы агенты достигали максимально ожидаемого результата.

## Контекст

- **Кто пользователь:** техножрец — человек-оператор, который использует сильные стороны человека (вкус, воля, семантическое понимание, persistent memory) и сильные стороны AI (пропускная способность, неутомимость, механическая согласованность) в связке.
- **Аудитория:** инфраструктура для класса людей-операторов, не персональный инструмент одного автора.
- **Первичный артефакт:** предпочтения пользователя. Решения и командные артефакты — после формирования одиночного техножреца.
- **Намерения (Intent):** единица намерения, в которую техножрец приносит работу — руками или подсасывая из jira, мессенджеров, багтрекеров. Throne помогает раскрыть намерение и предоставить его агенту вместе с предпочтениями.
...
- **Цикл улучшения:** оператор грузит дампы своих диалогов с агентами → Throne предлагает патчи к предпочтениям → следующий результат ближе к ожиданиям, чем предыдущий.
