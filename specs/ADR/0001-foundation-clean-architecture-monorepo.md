...
1. **Монорепо** с layout `apps/api/` (.NET backend) и будущим `apps/web/` (фронтенд). На корне репозитория — `specs/`, `scripts/quality/`, `.quality/`, `AGENTS.md`, `CLAUDE.md`, `DESIGN.md`, `readme.md`.
