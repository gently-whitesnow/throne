...
**Update 2026-06-21:** operational MCP tools are retired by [ADR-0043](0043-static-operational-skills-and-mcp-removal.md). `Intent.text` agent operations now run through `bin/throne-intent` over HTTP; the historical MCP tool semantics below are superseded for runtime.
