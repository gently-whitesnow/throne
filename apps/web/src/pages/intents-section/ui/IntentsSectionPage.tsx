...
export function IntentsSectionPage() {
  ...
  return (
    <div className="grid h-screen overflow-hidden max-md:grid-cols-1 max-md:grid-rows-[minmax(120px,26vh)_minmax(160px,32vh)_1fr] md:grid-cols-[200px_320px_1fr] md:grid-rows-1">
      <IntentContextRail />
      <IntentBoard />
      <section
