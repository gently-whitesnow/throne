    ...
    if (state.items.length === 0) {
      return (
        <p className="m-0 rounded border border-base-300 bg-base-100 p-4 text-sm text-base-content/60">
          Записей ещё нет. Скопируй промпт выше, запусти dream-проход в
          подключённом агенте — фронтир сам прочитает диалоги локально,
          предложит патчи и запишет результат сюда.
        </p>
      );
    }
    return (
