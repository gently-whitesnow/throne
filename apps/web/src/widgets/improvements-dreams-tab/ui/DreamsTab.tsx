    ...
    if (state.items.length === 0) {
      return (
        <p className="m-0 rounded border border-base-300 bg-base-100 p-4 text-sm text-base-content/60">
          Записей пока нет. Dream автоматически улучшает блоки промпта по твоим
          реальным диалогам с агентами. Запусти dream-проход в подключённом
          агенте скиллом «/dream»: он разберёт диалоги, предложит правки блоков
