...
/**
 * Колонка-поток одной роли (SYSTEM / USER): включённые части — рамками, доступные
 * выключенные — чипами внизу. Раскладка по ролям лучше ложится на широкий монитор,
 * чем единый вертикальный список.
 */
