    ...
    >
      ...
      {showFinishQuickAction ? (
        <button
          ...
          aria-label="Завершить — перевести в done"
          title="Завершить"
          className="inline-flex h-7 items-center gap-1 rounded-full bg-success/15 px-2.5 text-xs font-bold text-success transition hover:bg-success/25 disabled:opacity-60"
        >
          <CheckCheck aria-hidden size={12} strokeWidth={2.5} />
          <span>Завершить</span>
        </button>
      ) : null}
