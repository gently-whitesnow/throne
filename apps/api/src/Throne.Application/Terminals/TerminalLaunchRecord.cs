...
/// <c>POST /terminal/skills/attach</c>. Stored per intent and echoed back by the run
...
/// respawn. The run pipeline never overwrites it — only the attach handler updates
