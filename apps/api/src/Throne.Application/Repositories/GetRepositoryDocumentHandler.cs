...
/// <summary>
/// Thin read path over <see cref="IRepositoryArtifactRepository.FindBySlugAsync"/>.
/// Returns the page so callers can read its <c>version</c> back as the next
/// write's <c>expected_version</c>; a missing page maps to the typed
/// <see cref="ApiException"/> contract.
/// </summary>
