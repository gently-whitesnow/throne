...
namespace Throne.PromptPartPatches.Contracts.Generated
{
    ...
    public enum PromptPartPatchStatus
    {
    ...
    public partial class PromptPartPatchDto
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Target_scope { get; set; }

        /// <summary>
        /// Key of the target prompt part.
        /// </summary>
        ...
        [System.Text.Json.Serialization.JsonPropertyName("base_version")]
        [System.ComponentModel.DataAnnotations.Range(0, int.MaxValue)]
        public int Base_version { get; set; }

        [System.Text.Json.Serialization.JsonPropertyName("applied_version")]
        [System.ComponentModel.DataAnnotations.Range(1, int.MaxValue)]
        public int Applied_version { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ProposePromptPartPatchRequest
    {

        /// <summary>
        /// Must be `user`; system prompt parts are manifest-managed.
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("target_scope")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Target_scope { get; set; }
        ...
        /// <summary>
        /// Whole new text for replace_text/create; empty for structural operations.
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("patch_text")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Patch_text { get; set; }
        ...
        [System.Text.Json.Serialization.JsonPropertyName("operation")]
        [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter<PromptPartPatchOperation>))]
        public PromptPartPatchOperation Operation { get; set; } = Throne.PromptPartPatches.Contracts.Generated.PromptPartPatchOperation.Replace_text;

        /// <summary>
        /// Desired mode roles for create/set_roles.
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("mode_roles")]
        public System.Collections.Generic.ICollection<PromptPartModeRoleDto> Mode_roles { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PromptPartPatchPageDto
    {

        [System.Text.Json.Serialization.JsonPropertyName("items")]
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.Generic.ICollection<PromptPartPatchDto> Items { get; set; } = new System.Collections.ObjectModel.Collection<PromptPartPatchDto>();
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PromptPartPatchDetailDto
    {

        [System.Text.Json.Serialization.JsonPropertyName("patch")]
        [System.ComponentModel.DataAnnotations.Required]
        public PromptPartPatchDto Patch { get; set; } = new PromptPartPatchDto();

        /// <summary>
        /// Current text of the target prompt part; empty string when missing.
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("current_part_text")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Current_part_text { get; set; }

        [System.Text.Json.Serialization.JsonPropertyName("current_part_version")]
        [System.ComponentModel.DataAnnotations.Range(0, int.MaxValue)]
        public int Current_part_version { get; set; }

        /// <summary>
        /// True when patch.base_version == current_part_version.
        /// </summary>
        ...
        /// <summary>
        /// Prompt part text reconstructed at `patch.base_version` — i.e. the text the agent saw when proposing the patch. Empty string when the patch creates the part from scratch (`base_version=0`) or when version history is not available. Used by the operator UI to render a diff.
        /// <br/>
        /// </summary>
        [System.Text.Json.Serialization.JsonPropertyName("base_part_text")]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Base_part_text { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ApplyPromptPartPatchRequest
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class RejectPromptPartPatchRequest
    {
