...
/// <summary>
/// Normalises the ETag echoed by the upstream PR review-comments endpoint
/// before it is persisted on <see cref="IntentRepositoryBindingState.ReviewCommentsEtag"/>.
