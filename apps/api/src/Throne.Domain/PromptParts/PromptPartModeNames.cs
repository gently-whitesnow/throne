...
/// modes (<c>interview</c>/<c>work</c>/<c>review</c>/<c>dream</c>/<c>schema_map</c>) consumed by
...
public static class PromptPartModeNames
{
    ...
    public static readonly IReadOnlyList<string> All = [Interview, Work, Review, Dream, SchemaMap, Free];
