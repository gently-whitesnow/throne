...
/// (see <see cref="Realtime.RealtimeController"/> and the infrastructure
/// <c>BackgroundService</c>s) — this only caps the worst case for anything that fails to.
/// The framework default of 30s is needlessly long for that role.
///
