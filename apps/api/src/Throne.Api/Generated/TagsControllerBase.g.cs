...
namespace Throne.Api.Generated
{
    ...
    public abstract class TagsControllerBase : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Normalizes the name (trim, lowercase, strip leading hashes). Returns 409 if a tag with the same normalized name already exists.
        /// </remarks>
        /// <returns>Created</returns>
        [Microsoft.AspNetCore.Mvc.HttpPost, Microsoft.AspNetCore.Mvc.Route("api/v1/tags", Name = "createTag")]
        ...
        /// </summary>
        /// <returns>OK</returns>
        [Microsoft.AspNetCore.Mvc.HttpPatch, Microsoft.AspNetCore.Mvc.Route("api/v1/tags/{id}", Name = "renameTag")]
        public abstract System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult<TagDto>> RenameTag([Microsoft.AspNetCore.Mvc.ModelBinding.BindRequired] string id, [Microsoft.AspNetCore.Mvc.FromBody] [Microsoft.AspNetCore.Mvc.ModelBinding.BindRequired] RenameTagRequest body);

        /// <summary>
        /// Delete a tag.
        /// </summary>
        /// <remarks>
        /// When detach=true the server removes this tag from every intent currently using it before deleting the tag itself. Without detach=true the call is rejected with 409 if the tag is still attached to any intent.
        /// </remarks>
        /// <param name="detach">Detach the tag from all intents before deleting.</param>
