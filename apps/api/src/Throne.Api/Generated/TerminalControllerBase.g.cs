...
namespace Throne.Api.Generated
{
    ...
    public abstract class TerminalControllerBase : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        ...
        /// <returns>Hook callback accepted. Body is empty for non-context-injecting events; for `UserPromptSubmit` it may carry a `hookSpecificOutput` block conforming to Claude Code's hook output protocol so the embedded agent learns about the intent's current attachment inventory in the same turn (ADR-0034 parity with the standalone `get_intent` path).</returns>
        ...
        public abstract System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult<TerminalHookCallbackResponse>> ReceiveIntentTerminalHook([Microsoft.AspNetCore.Mvc.ModelBinding.BindRequired] string intent_id, [Microsoft.AspNetCore.Mvc.ModelBinding.BindRequired] Event @event, [Microsoft.AspNetCore.Mvc.FromQuery] TerminalRunMode? mode = null);
