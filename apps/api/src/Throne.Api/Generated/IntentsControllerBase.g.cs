...
namespace Throne.Api.Generated
{
    ...
    public abstract class IntentsControllerBase : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        ...
        /// <param name="terminal_running">When true, return only intents that currently have a live embedded-terminal session (a `throne-{intent_id}` tmux session). The set is read live from tmux (no DB mirror); an empty tmux server yields an empty page.</param>
        /// <param name="query">Ranked full-text search over Intent.text (FTS5/BM25). Tokens are matched as case-insensitive AND prefixes; results come back ordered by relevance with a highlighted `snippet`, and `next_cursor` is null (single ranked page). When absent, the list uses the structural order from `sort`.</param>
        /// <returns>OK</returns>
        [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("api/v1/intents", Name = "listIntents")]
        public abstract System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult<IntentListPageDto>> ListIntents([Microsoft.AspNetCore.Mvc.FromQuery] string cursor = null, [Microsoft.AspNetCore.Mvc.FromQuery] int? limit = null, [Microsoft.AspNetCore.Mvc.FromQuery] System.Collections.Generic.IEnumerable<IntentStatus> status = null, [Microsoft.AspNetCore.Mvc.FromQuery] string tag = null, [Microsoft.AspNetCore.Mvc.FromQuery] bool? untagged = null, [Microsoft.AspNetCore.Mvc.FromQuery] string tracker = null, [Microsoft.AspNetCore.Mvc.FromQuery] string board = null, [Microsoft.AspNetCore.Mvc.FromQuery] bool? pinned = null, [Microsoft.AspNetCore.Mvc.FromQuery] bool? terminal_running = null, [Microsoft.AspNetCore.Mvc.FromQuery] string query = null, [Microsoft.AspNetCore.Mvc.FromQuery] IntentListSort? sort = null);
