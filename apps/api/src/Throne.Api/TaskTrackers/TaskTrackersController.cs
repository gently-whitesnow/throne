...
/// <summary>
/// Provider-neutral catalog surface for the task-tracker axis (ADR-0045/0046). Both reads resolve
/// straight off <see cref="ITaskTrackerProviderRegistry"/>; resolving an unknown key is the first
/// server boundary that closes the open wire key (422 provider-unsupported).
/// </summary>
