...
/// are O(1). Slice 1 ships with zero providers wired (the <c>github</c>
/// implementation arrives in T-06); the registry handles the empty case so the
/// host can boot and surface a clear «no providers registered» message to the
