...
/// reporting (logs, capability detection, spawn results). Keeps the multi-arm
/// inspection out of <see cref="TmuxSessionManager"/> so the manager type itself stays
/// within the per-type cyclomatic budget.
/// </summary>
