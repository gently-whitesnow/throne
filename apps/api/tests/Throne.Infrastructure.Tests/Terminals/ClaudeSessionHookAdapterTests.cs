...
public class ClaudeSessionHookAdapterTests
{
    ...
    public async Task Writes_both_hooks_and_returns_flag()
    {
        ...
        var args = await sut.PrepareSpawnArgsAsync("intent-1", root, TerminalRunModes.Work, CancellationToken.None);
    ...
    public async Task Bakes_spawn_mode_into_hook_url()
    {
        ...
        await sut.PrepareSpawnArgsAsync("intent-1", root, TerminalRunModes.Interview, CancellationToken.None);
