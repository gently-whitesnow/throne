...
public class IntentReplaceTextTests
{
    ...
    {
        var intent = Intent.Create(IntentId.New(), "hello world", tags: null, Created);
    ...
    {
        var intent = Intent.Create(IntentId.New(), "abc", tags: null, Created);
    ...
    {
        var intent = Intent.Create(IntentId.New(), "hello", tags: null, Created);
