...
public class IntentInsertAfterLineTests
{
    ...
    {
        var intent = IntentFactory.Create(IntentId.New(), "user-1", "alpha\nbeta", tagIds: null, Created);

        var result = IntentInsertTextOperation.AfterLine(intent, afterLine: 0, insertText: "head\n", "ver-1", Edited, TextVersionAuthor.Agent);
    ...
    {
        var intent = IntentFactory.Create(IntentId.New(), "user-1", "a\nb\nc", tagIds: null, Created);

        var result = IntentInsertTextOperation.AfterLine(intent, afterLine: 1, insertText: "X\n", "ver-1", Edited, TextVersionAuthor.Agent);
    ...
    public void Insert_at_total_lines_appends()
    {
        ...
        var result = IntentInsertTextOperation.AfterLine(intent, afterLine: 2, insertText: "\nc", "ver-1", Edited, TextVersionAuthor.Agent);
    ...
    public void Insert_out_of_range_returns_line_out_of_range()
    {
        ...
        var result = IntentInsertTextOperation.AfterLine(intent, afterLine: 5, insertText: "x", "ver-1", Edited, TextVersionAuthor.Agent);
    ...
    {
        var intent = IntentFactory.Create(IntentId.New(), "user-1", "a", tagIds: null, Created);

        var result = IntentInsertTextOperation.AfterLine(intent, afterLine: -1, insertText: "x", "ver-1", Edited, TextVersionAuthor.Agent);
    ...
    public void Multiline_insert_no_auto_newline()
    {
        ...
        IntentInsertTextOperation.AfterLine(intent, afterLine: 1, insertText: "X\nY", "ver-1", Edited, TextVersionAuthor.Agent);
