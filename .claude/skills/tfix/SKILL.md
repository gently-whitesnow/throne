...
3. Call `mcp__throne__get_instruction_bundle(mode="light_work", intent_id=<resolved id>)`.
...
Mode: light_work (review attached via add_intent_review before the bundle is fetched).
