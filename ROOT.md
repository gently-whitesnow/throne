...
**Миссия.** Throne — приложение агентной инженерии вокруг намерения (Intent): человек задаёт направление и верифицирует, агенты выполняют. Полный разворот — [readme.md#Миссия](readme.md#миссия); держи его как ориентир при любой правке.
